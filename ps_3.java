...
// parameter. If no institution with the given location is not present in the array of institution objects, then the method 
// should return 0.
...
public class ps_3 {
    public static void main(String[] args) {
        ...
        if(res != null) System.out.println(res.getInstitutionName() + "::" + res.getGrade());
...
class Institution {
    ...
    // constructor
    public Institution(String institutionId, String institutionName, int noOfStudentsPlaced, int noOfStudentsCleared, String location){
